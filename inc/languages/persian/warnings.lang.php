...
$l['redirect_warned_banned'] = "<br /><br />همچنین کاربر به دلیل {2} به گروه {1} منتقل گردیده است.";
$l['redirect_warned_suspended'] = "<br /><br />دسترسی این کاربران در ارسال به حالت تعلیق در آمده است {1}.";
$l['redirect_warned_moderate'] = "<br /><br />تمام ارسال‌های این کاربر هم اکنون برای {1} بررسی خواهد شد.";
...
$l['error_warning_system_disabled'] = "شما نمی‌توانید از سیستم اخطار استفاده نمایید زیرا توسط مدیریت انجمن غیر فعال شده است.";
