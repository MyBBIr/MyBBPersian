...
$l['login_username2'] = "نام‌کاربری / رایانامه";
...
$l['postbit_reputation_add'] = "اهداء اعتبار به این کاربر";
...
$l['size_kb'] = "KB";
$l['size_bytes'] = "بایت";
$l['slaps'] = " با یک ماهی بزرگ";
$l['with_trout'] = "را سیلی میزند.";
...
$l['newpm_notice_one'] = "<strong>شما یک پیام خصوصی خوانده نشده </strong> از سوی {1} با عنوان <a href=\"{2}/private.php?action=read&amp;pmid={3}\" style=\"font-weight: bold;\">{4}</a> دارید.";
$l['newpm_notice_multiple'] = "<strong> شما {1} پیام خصوصی خوانده نشده دارید.</strong> جدید ترین پیام از سوی {2} با عنوان <a href=\"{3}/private.php?action=read&amp;pmid={4}\" style=\"font-weight: bold;\">{5}</a> می‌باشد.";
