...
$l['forum_selection_single'] = "جعبه‌ی انتخاب یک انجمن";
$l['group_selection_box'] = "جعبه‌ی انتخاب گروه";
$l['group_selection_single'] = "جعبه‌ی انتخاب یک گروه";
...
$l['error_chmod_settings_file'] = "فایل تنظیمات \"./inc/settings.php\" قابل نوشتن نیست. لطفاً CHMOD را به 777 تغییر بدهید.<br />جهت کسب اطلاعات بیشتر در مورد  CHMOD کردن، <a href=\"https://docs.mybb.com/1.8/administration/security/file-permissions\" target=\"_blank\" rel=\"noopener\">مستندات MyBB</a> را مطالعه نمایید.";
...
$l['success_settings_updated_hiddencaptchaimage'] = '<div class="smalltext" style="font-weight: normal;">لطفا دقت کنید که تنظیم<strong>فیلد کپچای پنهان</strong> به دلیل تداخل با فیلد <strong>{2}</strong> در فیلد ثبت‌نام به <strong>{1}</strong> برگشته‌است.</div>';
$l['success_settings_updated_username_method'] = '<div class="smalltext" style="font-weight: normal;">لطفا دقت کنید که تنظیم<b>روش‌های ورود مجاز</b> به دلیل وجود کاربرانی با ایمیل یکسان تغییر نکرده‌است.</div>';
$l['success_settings_updated_allowmultipleemails'] = '<div class="smalltext" style="font-weight: normal;">لطفا دقت کنید که تنظیم <b>ایمیل‌ها بتواند چندین باز ثبت‌نام شود؟</b> به دلیل اینکه تنظیم این بر روی<b>روش‌های ورود مجاز</b> امکان ورود با ایمیل است، نمی‌تواند فعال شود.</div>';
$l['success_settings_updated_captchaimage'] = '<div class="smalltext" style="font-weight: normal;">لطفا دقت کنید که تنظیم <strong>تصویر‌های کپچا برای ثبت‌نام و ارسال‌کردن</strong> به دلیل غلط بودن کلید عمومی/خصوصی آن، به  <strong>کپچای پیش‌فرض مای بی‌بی</strong> برگشته‌است.</div>';
...
$l['setting_cookiesecureflag'] = 'پرچم کوکی امن';
$l['setting_cookiesecureflag_desc'] = 'می‌توان به کوکی‌ها پرچم امن بودن داد تا از ارسال آن‌ها به اتصال‌های غیرامن جلوگیری شود، شما تنها زمانی باید این تنظیم را فعال کنید که انجمن شما به طور کامل با HTTPS کار کند.';
...
$l['setting_captchaimage_desc'] = 'برای جلوگیری از فرایند های خودکار عضویت و ارسال کردن شما می توانید نوع تصویر امنیتی را که کاربر باید آنرا کامل کند را وارد کنید. برای اطلاعات بیشتر  در مورد کپچاها مستندات مای بی بی را مشاهده نمایید.';
$l['setting_captchaimage_0'] = 'بدون CAPTCHA';
$l['setting_captchaimage_1'] = 'کپچای پیش‌فرض مای بی‌بی';
...
$l['setting_reportmethod'] = 'نحوه‌ی اطلاع‌رسانی محتوا‌های گزارش‌شده';
$l['setting_reportmethod_desc'] = 'لطفا از لیست زیر نحوه‌ای که وقتی محتوایی گزارش‌داده شد، به مدیرانتان اطلاع داده‌شود را انتخاب کنید.
توجه: مدیران تنها در صورتی برای ارسال‌ها مورد اطلاع قرار می‌گیرند که مدیر انجمن آن ارسال باشند و تنها در صورتی که مدیر اراشد باشند، از گزارش بقیه‌ی ارسال‌ها مورد اطلاع قرار می‌گیرند.';
$l['setting_reportmethod_db'] = 'فقط در پنل ناظم نمایش داده شوند.';
$l['setting_reportmethod_pms'] = 'توسط پیام‌خصوصی ارسال شوند و پنل ناظم نمایش داده شوند.';
$l['setting_reportmethod_email'] = 'توسط ایمیل ارسال شوند و پنل ناظم نمایش داده شوند.';
$l['setting_statslimit'] = 'محدودیت آمار';
$l['setting_statslimit_desc'] = 'تعداد موضوعاتی که می‌خواهید در صفحه‌ی آمار برای بیشترین پاسخ‌ها و بیشترین بازدید‌ها نمایش داده شود را وارد نمائید. برای غیرفعال‌کردن بر روی ۰ قرار دهید.';
...
$l['setting_thousandssep_desc'] = 'نقطه‌گذاری‌ای که می‌خواهید از آن استفاده فرمائید.  مثلا می‌توانید با استفاده از\',\'عدد1200 را به 1,200 تبدیل می‌شود.';
...
$l['setting_maxmultipagelinks_desc'] = 'در اینجا شما می‌توانید تعداد پیوند‌های صفحات قبلی و بعدی که در صفحه‌بندی موضوعات و انجمن‌ها نشان داده شوند را وارد کنید. برای غیرفعال کردن محدودیت بر روی ۰ قرار دهید.';
...
$l['setting_announcementshtml'] = 'اجازه‌ی HTML در اطلاعیه‌ها؟';
$l['setting_announcementshtml_desc'] = 'آیا مدیران اجازه‌ی فعال‌سازی تجزیه‌ی HTML در اطلاعیه‌ها را داشته‌باشند؟';
...
$l['setting_errorlogmedium_log'] = 'گزارش خطاها';
$l['setting_errorlogmedium_email'] = 'ایمیل‌کردن خطاها';
$l['setting_errorlogmedium_both'] = 'ایمیل‌کردن و گزارش خطاها';
...
$l['setting_errortypemedium_warning'] = 'هشدار‌ها';
$l['setting_errortypemedium_error'] = 'خطاها';
$l['setting_errortypemedium_both'] = 'خطاها و هشدارها';
$l['setting_errortypemedium_none'] = 'پنهان‌سازی خطاها و هشدارها';
...
$l['setting_enableforumjump_desc'] = 'منوی پرش به انجمن در نمایش موضوع در پایین صفحه نمایش داده میشود. اگر تعداد انجمن بالایی دارید این گزینه می‌تواند به کاربران شما در مشاهده هر چه بهتر انجمن ها کمک کند . برای غیر فعال سازی \'No\' را انتخاب کنید.';
...
$l['setting_usecdn_desc'] = 'شما می‌توانید از CDN (Content Delivery Network = شبکه ارائه محتوا) بهره ببرید  برای جلوگیری از لود دوباره فایل هایی مثل :  Cssها , JavaScriptها  و تصاویر . آیا میخواهید این قابلیت را فعال کنید ؟ ';
...
دقت کنید که این می‌تواند موجب کاهش عمل‌کرد پایگاه داده و اجرای کوئری‌های بسیار شود. لطفا <a href="https://docs.mybb.com/versions/1.6.5/">مستندات مای بی‌بی</a> را برای اطلاعات بیشتر این تغییر مشاهده کنید.';
...
$l['setting_postmaxavatarsize_desc'] = 'حداکثر اندازه‌ی آواتارها که در یک ارسال نمایش داده شود. اگر یک آواتار خیلی بزرگ باشد یه صورت خودکار کوچک خواهد شد. برای غیرفعال‌کردن محدودیت بر روی ۰ قرار دهید.';
...
$l['setting_similarlimit'] = 'محدودیت تعداد موضوع های مشابه';
...
$l['setting_regtype_instant'] = 'فعال‌سازی سریع';
$l['setting_regtype_verify'] = 'ارسال ایمیل تایید سازی';
$l['setting_regtype_randompass'] = 'ارسال رمز تصادفی';
$l['setting_regtype_admin'] = 'فعال‌سازی توسط مدیر';
$l['setting_regtype_both'] = 'ارسال ایمیل تاییدسازی و فعال‌سازی توسط مدیر';
...
$l['setting_coppa_deny'] = 'انکار کاربران زیر ۱۳ سال';
$l['setting_coppa_disabled'] = 'غیرفعال‌سازی این ویژگی';
$l['setting_username_method'] = 'روش‌های ورود کاربر به انجمن';
$l['setting_username_method_desc'] = 'شما می‌توانید روشهای ورود کاربر به انجمن را انتخاب کنید.ورود با ایمیل ، ورود با نام کاربری ، ورود با ایمیل و نمام کاربری.
<br />برای اینکه ورود با ایمیل یکی از روش‌های ورود معتبر شود، کاربران امکان استفاده از ایمیل مشترک را نخواهند داشت.';
$l['setting_username_method_0'] = 'فقط نام‌کاربری';
$l['setting_username_method_1'] = 'فقط ایمیل';
$l['setting_username_method_2'] = 'هم نام‌کاربری و هم ایمیل';
...
$l['setting_useravatar_desc'] = 'اگر کاربری یک آواتار سفارشی برای خود انتخاب نکرده‌بود، این آواتار به جای آن استفاده خواهد شد.اگر شما می‌خواهید تصویر متفاوتی برای پوسته‌های متفاوت استفاده‌کنید، لطفا از <strong>{theme}</strong> که بیان‌کننده‌ی مسیر پوشه‌ی پوسته‌ است استفاده کنید.';
...
$l['setting_avatarresizing_auto'] = 'به  صورت خودکار آواتارهای بزرگ را تغییر اندازه بده';
$l['setting_avatarresizing_user'] = 'به کاربر اجازه بده تا آواتارهای بزرگ را تغییر اندازه دهد';
$l['setting_avatarresizing_disabled'] = 'غیرفعال‌سازی این ویژگی';
...
$l['setting_allowremoteavatars'] = 'اجازه‌ی آواتار‌های لینک داده‌شده';
$l['setting_allowremoteavatars_desc'] = 'اگر می‌خواهید کاربران بتوانند از آواتار از سرور‌های دیگر استفاده کنند این تنظیم را فعال کنید.
فعال کردن این تنظیم این امکان را فراهم می‌آورد که آی‌پی سرور شما لو رود.';
$l['setting_customtitlemaxlength'] = 'حداکثر طول عنوان اختیاری کاربر';
$l['setting_customtitlemaxlength_desc'] = 'حداکثر طولی که کاربر می‌تواند برای عنوان اختیاری وارد کند را وارد کنید. برای غیرفعال کردن محدودیت بر روی ۰ قرار دهید.';
...
$l['setting_postmergemins_desc'] = 'با فعال شدن این گزینه ارسال‌هایی که در x دقیقه به دست یک کاربر پشت سر هم ارسال می شوند با هم ادغام خواهند شد. برای غیر فعال کردن عدد 0 را وارد کنید. پیش‌فرض: 60';
...
$l['setting_showeditedbyadmin'] = 'نمایش \'ویرایش شده توسط\' برای ارسال مدیران و ناظمان';
...
$l['setting_maxpolloptions_desc'] = 'بیشترین تعداد گزینه های یک نظرسنجی که کاربر می تواند ارسال کند. برای غیرفعال‌کردن محدودیت بر روی ۰ قرار دهید.';
$l['setting_polltimelimit'] = 'محدودیت ساعتی نظرسنجی';
$l['setting_polltimelimit_desc'] = 'عدد مربوط به تعداد ساعاتی که یک کاربر عادی قادر به ارسال نظرسنجی برای موضوع‌های خود نخواهد بود. عدد 0 بیانگر عدم محدودیت این مورد است.';
...
$l['setting_maxattachments_desc'] = 'حداکثر تعداد پیوستی که کاربر اجازه بارگذاری آن را برای هرارسال دارد. برای غیرفعال‌کردن محدودیت بر روی ۰ قرارد هید.';
...
$l['setting_default_memberlist_sortby_postnum'] = 'تعداد ارسال';
...
$l['setting_searchtype_desc'] = 'لطفا نوع سیستم جستجو را انتخاب کنید. شما می‌توانید یکی از دو حالت "استاندارد" و یا "تمام متن" را انتخاب کنید (با توجه به پایگاه داده خود).حالت تمام متن قویتر و سریعتر از حالت جستجوی استاندارد مای بی بی می باشد.';
...
$l['setting_secure_smtp_0'] = 'بدون رمزگذاری';
$l['setting_secure_smtp_1'] = 'رمزگذاری SSL';
$l['setting_secure_smtp_2'] = 'رمزگذاری TSL';
$l['setting_mail_parameters'] = 'پارامتر‌های اضافه برای تابع mail() پی‌اچ‌پی';
$l['setting_mail_parameters_desc'] = 'این تنظیم به شما اجازه می‌دهد تا پارامتر‌های اضافه برای تابع mail() تنظیم کنید. <br />تنها لازم است اگر PHP Mail به عنوان گرداننده‌ی ایمیل انتخاب شده‌باشد. <a href="http://php.net/function.mail" target="_blank" rel="noopener">اطلاعات بیشتر</a>';
...
$l['setting_mail_logging_1'] = 'ثبت ایمیل‌ها بدون محتوا';
$l['setting_mail_logging_2'] = 'ثبت هرچیزی';
...
$l['setting_purgespammerapikey_desc'] = 'به منظور اینکه اطلاعات یک اسپمر در پایگاه داده Stop Forum Spam ذخیره شود،شما به یک کلید API نیاز دارید.شما می‌توانید یکی از آنها را از <a href="https://www.stopforumspam.com/forum/register.php" target="_blank" rel="noopener">اینجا</a> بدست آورید.زمانی که کلید خود را بدست آوردید، آن را در جعبه زیر بنویسید.';
...
$l['setting_allowgooglefield'] = 'اعطای اجازه به گروه ها برای استفاده از فیلد هنگ‌اوت گوگل';
$l['setting_allowgooglefield_desc'] = 'گروه های کاربری را که مجازند تا از فیلد تماس هنگ‌اوت گوگل استفاده کنند،انتخاب کنید';
