...
$l['setting_purgespammerapikey_desc'] = 'به منظور اینکه اطلاعات یک اسپمر در پایگاه داده Stop Forum Spam ذخیره شود،شما به یک کلید API نیاز دارید.شما می‌توانید یکی از آنها را از <a href="http://stopforumspam.com/signup" target="_blank">اینجا</a> بدست آورید.زمانی که کلید خود را بدست آوردید، آن را در جعبه زیر بنویسید.';
