...
function upgrade41_dbchanges()
{
	...
	$output->print_header("بزورسانی پایگاه‌داده");
...
function upgrade41_dbchanges2()
{
	...
	$output->print_contents("<p>برای ادامه‌ی فرایند بروزرسانی روی بعدی کلیک کنید.</p>");
...
function upgrade41_dbchanges3()
{
	...
	echo "<p>انجام کوئری‌های لازم برای بروزرسانی...</p>";
	flush();
	...
	$output->print_contents("<p>لطفا برای ادامه‌ی فرایند بروزسانی روی بعدی کلیک کنید.</p>");
