...
$l['mybb_incorrect_folder'] = "<div class=\"border_wrapper upgrade_note\" style=\"padding: 4px;\">
	...
	<p>درحالی که مشکلی با آن نیست، به شما توصیه می‌شود که محتویات پوشه‌ی «Upload» را در سایت خود آپلود کنید، نه خود آن پوشه‌را.<br /><br />برای اطلاعات بیشتر لطفا <a href=\"https://docs.mybb.com/1.8/install/#uploading-files\" target=\"_blank\">MyBB Docs</a> مستندات مای بی‌بی را مشاهده نمایید.</p>
</div>";
...
$l['req_step_error_configfile'] = 'فایل پیکربندی (inc/config.php) قابل نوشتن نیست.لطفا صفحه <a href="https://docs.mybb.com/1.8/administration/security/file-permissions" target="_blank">دسترسی‌ها</a> مطالعه کنید تا بتوانید دسترسی فایل را برای قابل نوشتن شده تغییر دهید.';
$l['req_step_error_settingsfile'] = 'فایل تنظیمات (inc/settings.php) قابل نوشتن نیست. لطفا صفحه <a href="https://docs.mybb.com/1.8/administration/security/file-permissions" target="_blank">دسترسی‌ها</a> مطالعه کنید تا بتوانید دسترسی فایل را برای قابل نوشتن شده تغییر دهید.';
$l['req_step_error_cachedir'] = 'پوشه کش (cache/) قابل نوشتن نیست. لطفا صفحه <a href="https://docs.mybb.com/1.8/administration/security/file-permissions" target="_blank">دسترسی‌ها</a> مطالعه کنید تا بتوانید دسترسی فایل را برای قابل نوشتن شده تغییر دهید.';
$l['req_step_error_uploaddir'] = 'پوشه پیوست‌ها (uploads/) قابل نوشتن نیست. لطفا صفحه <a href="https://docs.mybb.com/1.8/administration/security/file-permissions" target="_blank">دسترسی‌ها</a>  مطالعه کنید تا بتوانید دسترسی فایل را برای قابل نوشتن شده تغییر دهید.';
$l['req_step_error_avatardir'] = 'پوشه آواتارها (uploads/avatars/) قابل نوشتن نیست لطفا صفحه <a href="https://docs.mybb.com/1.8/administration/security/file-permissions" target="_blank">دسترسی‌ها</a> مطالعه کنید تا بتوانید دسترسی فایل را برای قابل نوشتن شده تغییر دهید.';
$l['req_step_error_cssddir'] = 'پوشه فایلهای سی اس اس (css/) قابل نوشتن نیست لطفا صفحه <a href="https://docs.mybb.com/1.8/administration/security/file-permissions" target="_blank">دسترسی‌ها</a> مطالعه کنید تا بتوانید دسترسی فایل را برای قابل نوشتن شده تغییر دهید.';
...
$l['config_step_table'] = '<p>اکنون وقت آن رسیده است که شما انجمن خود را پیکربندی کنید، در اینجا شما باید عنوان انجمن، آدرس انجمن، تنظیمات کوکی های دامنه ، ایمیل انجمن و ... را انجام دهید..</p>
		<div class="border_wrapper">
			...
			<table class="general" cellspacing="0">
				...
				<tr>
					<th colspan="2" class="first last">تنظیمات کوکی‌ها <a title="چیست؟" target="_blank" href="https://docs.mybb.com/1.8/development/cookies">(؟)</a></th>
				</tr>
				<tr>
