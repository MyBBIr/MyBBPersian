...
$l['upgrade_complete'] = 'تکمیل بروزرسانی';
...
$l['mybb_incorrect_folder'] = "<div class=\"border_wrapper upgrade_note\" style=\"padding: 4px;\">
	<h3>مای بی‌بی متوجه شده‌است که شما آن‌را از طریق پوشه‌ی «Upload» اجرا می‌کنید.</h3>
	<p>درحالی که مشکلی با آن نیست، به شما توصیه می‌شود که محتویات پوشه‌ی «Upload» را در سایت خود آپلود کنید، نه خود آن پوشه‌را.<br /><br />برای اطلاعات بیشتر لطفا <a href=\"https://docs.mybb.com/1.8/install/#uploading-files\" target=\"_blank\" rel=\"noopener\">مستندات مای بی‌بی</a> را مشاهده نمایید.</p>
</div>";
...
$l['req_step_error_xmlsupport'] = 'مای بی بی نیازمند PHP همراه با قابلیت پردازش اطلاعات XML می‌باشد. لطفا برای اطلاعات بیشتر صفحه <a href="http://www.php.net/xml" target="_blank" rel="noopener">PHP.net</a> را مشاهده فرمائید.';
$l['req_step_error_configdefaultfile'] = 'فایل (inc/config.default.php) توانایی تغییر نام ندارد.لطفا به‌طور دستی نام فایلِ <u>config.default.php</u> را به <u>config.php</u> تغییر دهید تا فایل پیکربندی قابل نوشتن شود یا با ما تماس بگیرید <a href="http://my-bb.ir" targert="_blank" rel="noopener">پشتیبانی مای‌بی‌بی</a>';
$l['req_step_error_configfile'] = 'فایل پیکربندی (inc/config.php) قابل نوشتن نیست.لطفا صفحه <a href="https://docs.mybb.com/1.8/administration/security/file-permissions" target="_blank" rel="noopener">دسترسی‌ها</a> مطالعه کنید تا بتوانید دسترسی فایل را برای قابل نوشتن شده تغییر دهید.';
$l['req_step_error_settingsfile'] = 'فایل تنظیمات (inc/settings.php) قابل نوشتن نیست. لطفا صفحه <a href="https://docs.mybb.com/1.8/administration/security/file-permissions" target="_blank" rel="noopener">دسترسی‌ها</a> مطالعه کنید تا بتوانید دسترسی فایل را برای قابل نوشتن شده تغییر دهید.';
$l['req_step_error_cachedir'] = 'پوشه کش (cache/) قابل نوشتن نیست. لطفا صفحه <a href="https://docs.mybb.com/1.8/administration/security/file-permissions" target="_blank" rel="noopener">دسترسی‌ها</a> مطالعه کنید تا بتوانید دسترسی فایل را برای قابل نوشتن شده تغییر دهید.';
$l['req_step_error_uploaddir'] = 'پوشه پیوست‌ها (uploads/) قابل نوشتن نیست. لطفا صفحه <a href="https://docs.mybb.com/1.8/administration/security/file-permissions" target="_blank" rel="noopener">دسترسی‌ها</a>  مطالعه کنید تا بتوانید دسترسی فایل را برای قابل نوشتن شده تغییر دهید.';
$l['req_step_error_avatardir'] = 'پوشه آواتارها (uploads/avatars/) قابل نوشتن نیست لطفا صفحه <a href="https://docs.mybb.com/1.8/administration/security/file-permissions" target="_blank" rel="noopener">دسترسی‌ها</a> مطالعه کنید تا بتوانید دسترسی فایل را برای قابل نوشتن شده تغییر دهید.';
$l['req_step_error_cssddir'] = 'پوشه فایلهای سی اس اس (css/) قابل نوشتن نیست لطفا صفحه <a href="https://docs.mybb.com/1.8/administration/security/file-permissions" target="_blank" rel="noopener">دسترسی‌ها</a> مطالعه کنید تا بتوانید دسترسی فایل را برای قابل نوشتن شده تغییر دهید.';
...
$l['config_step_table'] = '<p>اکنون وقت آن رسیده است که شما انجمن خود را پیکربندی کنید، در اینجا شما باید عنوان انجمن، آدرس انجمن، تنظیمات کوکی های دامنه ، ایمیل انجمن و ... را انجام دهید..</p>
		<div class="border_wrapper">
			...
			<table class="general" cellspacing="0">
				...
				<tr>
					<th colspan="2" class="first last">تنظیمات کوکی‌ها <a title="چیست؟" target="_blank" href="https://docs.mybb.com/1.8/development/cookies" rel="noopener">(؟)</a></th>
				</tr>
				<tr>
...
<p>گروه مای‌بی بی از شما قدر دان به خاطر نصب سیستم مای بی بی و حمایت از آنهاست، در صورتی که به مشکلی برخوردید می توانید با <a href="http://My-BB.Ir/" target="_blank" rel="noopener">پشتیبانی فارسی این سیستم</a> تماس بگیرید.</p>';
...
$l['no_theme_functions_file'] = 'فایل کارهای قالب یافت نشد. مطمئن شوید که همه‌ی فایل‌ها را به طور کامل آپلود کرده‌اید.';
