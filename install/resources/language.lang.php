...
$l['mybb_incorrect_folder'] = "<div class=\"border_wrapper upgrade_note\" style=\"padding: 4px;\">
	...
	<p>درحالی که مشکلی با آن نیست، به شما توصیه می‌شود که محتویات پوشه‌ی «Upload» را در سایت خود آپلود کنید، نه خود آن پوشه‌را.<br /><br />برای اطلاعات بیشتر لطفا <a href=\"https://docs.mybb.com/1.8/install/#uploading-files\" target=\"_blank\" rel=\"noopener\">MyBB Docs</a> مستندات مای بی‌بی را مشاهده نمایید.</p>
</div>";
...
$l['config_step_table'] = '<p>اکنون وقت آن رسیده است که شما انجمن خود را پیکربندی کنید، در اینجا شما باید عنوان انجمن، آدرس انجمن، تنظیمات کوکی های دامنه ، ایمیل انجمن و ... را انجام دهید..</p>
		<div class="border_wrapper">
			...
			<table class="general" cellspacing="0">
				...
				<tr>
					<th colspan="2" class="first last">تنظیمات کوکی‌ها <a title="چیست؟" target="_blank" rel="noopener" href="https://docs.mybb.com/1.8/development/cookies">(؟)</a></th>
				</tr>
				<tr>
