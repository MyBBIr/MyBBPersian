...
if(!$mybb->input['action'])
{
	...
	while($section = $db->fetch_array($query))
	{
		...
		{
			$table->construct_cell("<div style=\"padding-right: 40px;\"><div><strong><a href=\"index.php?module=config-help_documents&amp;action=edit&amp;hid={$doc['hid']}\">{$doc['name']}</a></strong><br /><small>{$doc['description']}</small></div></div>");
