...
if(!$mybb->input['action'])
{
	...
	while($log = $db->fetch_array($query))
	{
		...
		$find_from = "<div class=\"float_left\"><a href=\"index.php?module=tools-mailerrors&amp;toaddress={$log['toaddress']}\"><img src=\"styles/{$page->style}/images/icons/find.png\" title=\"{$lang->fine_emails_to_addr}\" alt=\"{$lang->find}\" /></a></div>";
