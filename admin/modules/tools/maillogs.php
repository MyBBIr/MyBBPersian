...
if(!$mybb->input['action'])
{
	...
	while($log = $db->fetch_array($query))
	{
		...
		elseif($log['type'] == 1)
		{
			...
			$find_to = "<div class=\"float_left\"><a href=\"index.php?module=tools-maillogs&amp;touid={$log['touid']}\"><img src=\"styles/{$page->style}/images/icons/find.png\" title=\"{$lang->find_emails_to_user}\" alt=\"{$lang->find}\" /></a></div>";
			if(!$log['to_username'])
			{
