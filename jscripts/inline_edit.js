...
inlineEditor.prototype = {
	initialize: function(url, options)
	{
		...
		{
			alert('شما نیاز به مشخصه‌ی className در تنظیمات دارید.');
			return false;
		}
	...
	makeEditable: function(element)
	{
		...
		{
			this.options.lang_click_edit = "(برای ویرایش کلیک کنید و نگه دارید)";
		}
	...
	onComplete: function(request)
	{
		if(request.responseText.match(/<error>(.*)<\/error>/))
		{
			...
			alert('خطایی در انجام بروزرسانی رخ داده است.\n\n'+message[1]);
		}
	...
	showSpinner: function()
	{
		...
		if(!this.spinner)
		{
			...
			{
				this.spinner.alt = "در حال ذخیره تغییرات..";
			}
